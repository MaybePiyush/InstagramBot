...
By @StarkBots
    ...
    # Rest Buttons
    buttons = [
        [InlineKeyboardButton("✨ Bot Status and More Bots ✨", url="https://t.me/BotzArena/5")],
        [
...
A telegram bot to download instagram content by @BotzArena

Source Code : [Click Here](https://github.com/MaybePiyush)
